...
export const KLogo = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="34"
      height="34"
...
export const PenSunIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="22"
      height="22"
    ...
    >
      ...
      <g clipPath="url(#circleClip)">
        ...
        <g filter="url(#filter_blur)">
          <circle cx="34" cy="89" r="101" fill="#7FDEFF" />
        </g>
        <g filter="url(#filter_blur)">
          <circle cx="121" cy="84" r="45" fill="#FF47D6" />
        </g>
        <g filter="url(#filter_blur)">
          <circle cx="104" cy="120" r="115" fill="#7FDEFF" />
        </g>
        <g filter="url(#filter_blur)">
          <path d="M12 72 C68 10, 27 11, 95 123" fill="#FF0000" />
        </g>
        <g filter="url(#filter_blur)">
...
export const SettingIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      {...props}
      className={`h-5.5 w-5.5 transition-transform duration-200 ease-out group-hover:scale-110 ${
        props.className ?? ""
      }`}
    >
